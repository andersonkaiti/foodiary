    ...
    <View className="items-center justify-center">
      ...
      <View className="mt-2 w-full flex-row items-center justify-between py-4">
        <View className="w-1/3 items-center justify-center">
          ...
          <Text className="text-gray-700 text-sm">Proteínas</Text>
        </View>
        ...
        <View className="w-1/3 items-center justify-center">
          ...
          <Text className="text-gray-700 text-sm">Carboidratos</Text>
        </View>
        ...
        <View className="w-1/3 items-center justify-center">
          ...
          <Text className="text-gray-700 text-sm">Gorduras</Text>
        </View>
      </View>
    </View>
  )
